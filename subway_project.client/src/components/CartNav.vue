...
<template>
  ...
  <div class="cart">
    ...
    <div class="cart-header">
      ...
      <span
        v-if="orderStore.order.products.length > 0 || orderStore.order.subs.length > 0 || subStore.sub.products.length > 0">
        ...
        <h6 v-if="orderStore.order.totalCalories > 1800">1800+ is alot of calories, are you sure?</h6><br>
    ...
    <div>
      <div v-for="sub in groupedCartSubList" class="cart-item-sub">
        ...
        <div class="cart-item-sub-heading">
          ...
          <div>
            <button @click="orderStore.removeSub(sub)">x</button>
          </div>
        </div>
        <ul>
